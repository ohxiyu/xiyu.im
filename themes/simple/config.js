const CONFIG = {
  ...
  SIMPLE_CONTAINER_MAX_WIDTH:
    process.env.NEXT_PUBLIC_SIMPLE_CONTAINER_MAX_WIDTH || '95vw',
  SIMPLE_CONTAINER_MAX_WIDTH_2XL:
    process.env.NEXT_PUBLIC_SIMPLE_CONTAINER_MAX_WIDTH_2XL || '1900px',
  SIMPLE_ARTICLE_MAX_WIDTH:
    process.env.NEXT_PUBLIC_SIMPLE_ARTICLE_MAX_WIDTH || '1200px',
  SIMPLE_ARTICLE_MAX_WIDTH_2XL:
    process.env.NEXT_PUBLIC_SIMPLE_ARTICLE_MAX_WIDTH_2XL || '1700px',
  SIMPLE_NOTION_MAX_WIDTH:
    process.env.NEXT_PUBLIC_SIMPLE_NOTION_MAX_WIDTH || '960px',
  SIMPLE_NOTION_MAX_WIDTH_2XL:
    process.env.NEXT_PUBLIC_SIMPLE_NOTION_MAX_WIDTH_2XL || '1120px',
