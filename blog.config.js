...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'xiyu', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple,xiyu
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.svg', // blog favicon 配置, xiyu 主题默认使用 /favicon.svg
  BLOG_LOGO: process.env.NEXT_PUBLIC_BLOG_LOGO || '/images/logo/logo-mark.svg', // 站点 logo（xiyu 主题品牌 mark）
  BLOG_AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/images/logo/logo-256.png', // 作者头像（xiyu 主题 256 版）
