  ...
  contact: {
    ...
    sections: [
      ...
      },
      {
        heading: '公开联系渠道',
        paragraphs: [
          '目前公开且可验证的联系入口是 X 账号 @ohxiyu。为了减少垃圾信息和保护个人边界，本站暂不公开电话号码、家庭或办公地址，也没有在页面中硬编码私人邮箱。若未来启用独立的公开邮箱或组织联系信息，会在此页、结构化数据和 llms.txt 中同步更新，而不是只通过临时私信告知。',
