...
const BLOG = {
  ...
  THEME: 'xiyu', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  BIO:
    ...
    '长期持有比特币，用 AI Agent 给自己造系统。写作是公开的思考存档。', // 作者简介（关于页 Hero 的副标题）
